...
<!--        >-->
          <img
            :disabled="type == 1 "
            style="height: 62vw;margin-bottom: 20px;"
            class="select100"
            v-if="form.imgUrl"
...
<!--          <el-button :disabled="type == 1 " type="primary"  v-if="form.imgUrl"  size="small">重新上传</el-button >-->
          <el-button             class="select100"
                                 :disabled="type == 1 " type="primary"  v-if="!form.imgUrl" size="small" @click="uploadMaterial">拍摄图片</el-button>
          <el-button             class="select100"
                                 :disabled="type == 1 " type="primary"  v-if="form.imgUrl" size="small" @click="uploadMaterial">重新拍摄</el-button>
<!--        </el-upload>-->
      </mt-field>
